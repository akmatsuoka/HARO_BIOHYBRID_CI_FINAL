...
\makeatletter
% Map all requests for U/rsfs to a scalable rsfs10, so odd sizes work
\DeclareFontShape{U}{rsfs}{m}{n}{<-> s*[1.0] rsfs10}{}
% (optional) if you ever request italic RSFS:
\DeclareFontShape{U}{rsfs}{m}{it}{<-> s*[1.0] rsfsi10}{}
\makeatother
...
\begin{document}
\title[Article Title]{Toward Living Cochlear Implants: Using Canaliculi Perforantes Shuknecht to Guide stem cell-drived Neurite Regeneration}
...
\abstract{Cochlear implants (CIs) restore hearing by directly stimulating auditory neurons, yet a persistent electrode--neuron gap constrains spatial selectivity and the fidelity of complex listening. This review outlines a biohybrid approach that leverages the Canaliculi Perforante Schuknecht (CPS) to guide neurites toward recording/stimulation sites while enabling localized therapy. All the necessary components consist of biohybrid CIs are discussed.}
